...
import { createClientAsync as createActivityGroupServiceClient } from '../service/v202202/activitygroupservice'
import { createClientAsync as createActivityServiceClient } from '../service/v202202/activityservice'
import { createClientAsync as createAdRuleServiceClient } from '../service/v202202/adruleservice'
import { createClientAsync as createAdjustmentServiceClient } from '../service/v202202/adjustmentservice'
import { createClientAsync as createAudienceSegmentServiceClient } from '../service/v202202/audiencesegmentservice'
import { createClientAsync as createCdnConfigurationServiceClient } from '../service/v202202/cdnconfigurationservice'
import { createClientAsync as createCmsMetadataServiceClient } from '../service/v202202/cmsmetadataservice'
import { createClientAsync as createCompanyServiceClient } from '../service/v202202/companyservice'
import { createClientAsync as createContactServiceClient } from '../service/v202202/contactservice'
import { createClientAsync as createContentBundleServiceClient } from '../service/v202202/contentbundleservice'
import { createClientAsync as createContentServiceClient } from '../service/v202202/contentservice'
import { createClientAsync as createCreativeReviewServiceClient } from '../service/v202202/creativereviewservice'
import { createClientAsync as createCreativeServiceClient } from '../service/v202202/creativeservice'
import { createClientAsync as createCreativeSetServiceClient } from '../service/v202202/creativesetservice'
import { createClientAsync as createCreativeTemplateServiceClient } from '../service/v202202/creativetemplateservice'
import { createClientAsync as createCreativeWrapperServiceClient } from '../service/v202202/creativewrapperservice'
import { createClientAsync as createCustomFieldServiceClient } from '../service/v202202/customfieldservice'
import { createClientAsync as createCustomTargetingServiceClient } from '../service/v202202/customtargetingservice'
import { createClientAsync as createDaiAuthenticationKeyServiceClient } from '../service/v202202/daiauthenticationkeyservice'
import { createClientAsync as createDaiEncodingProfileServiceClient } from '../service/v202202/daiencodingprofileservice'
import { createClientAsync as createForecastServiceClient } from '../service/v202202/forecastservice'
import { createClientAsync as createInventoryServiceClient } from '../service/v202202/inventoryservice'
import { createClientAsync as createLabelServiceClient } from '../service/v202202/labelservice'
import { createClientAsync as createLineItemCreativeAssociationServiceClient } from '../service/v202202/lineitemcreativeassociationservice'
import { createClientAsync as createLineItemServiceClient } from '../service/v202202/lineitemservice'
import { createClientAsync as createLineItemTemplateServiceClient } from '../service/v202202/lineitemtemplateservice'
import { createClientAsync as createLiveStreamEventServiceClient } from '../service/v202202/livestreameventservice'
import { createClientAsync as createMobileApplicationServiceClient } from '../service/v202202/mobileapplicationservice'
import { createClientAsync as createNativeStyleServiceClient } from '../service/v202202/nativestyleservice'
import { createClientAsync as createNetworkServiceClient } from '../service/v202202/networkservice'
import { createClientAsync as createOrderServiceClient } from '../service/v202202/orderservice'
import { createClientAsync as createPlacementServiceClient } from '../service/v202202/placementservice'
import { createClientAsync as createProposalLineItemServiceClient } from '../service/v202202/proposallineitemservice'
import { createClientAsync as createProposalServiceClient } from '../service/v202202/proposalservice'
import { createClientAsync as createPublisherQueryLanguageServiceClient } from '../service/v202202/publisherquerylanguageservice'
import { createClientAsync as createReportServiceClient } from '../service/v202202/reportservice'
import { createClientAsync as createSiteServiceClient } from '../service/v202202/siteservice'
import { createClientAsync as createStreamActivityMonitorServiceClient } from '../service/v202202/streamactivitymonitorservice'
import { createClientAsync as createSuggestedAdUnitServiceClient } from '../service/v202202/suggestedadunitservice'
import { createClientAsync as createTargetingPresetServiceClient } from '../service/v202202/targetingpresetservice'
import { createClientAsync as createTeamServiceClient } from '../service/v202202/teamservice'
import { createClientAsync as createUserServiceClient } from '../service/v202202/userservice'
import { createClientAsync as createUserTeamAssociationServiceClient } from '../service/v202202/userteamassociationservice'
import { createClientAsync as createYieldGroupServiceClient } from '../service/v202202/yieldgroupservice'
